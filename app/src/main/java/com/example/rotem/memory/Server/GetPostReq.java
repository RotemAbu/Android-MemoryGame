 ...
 */
public class GetPostReq implements Runnable{

    String url="https://memogame1.herokuapp.com/api/getUser";
    String url_Parameters ;
    public static String minSteps;
    public GetPostReq(String url_Parameters) {
    ...
    public void run() {
        try {
            ...
            setResData(builder.toString());
        }
        catch (Exception e){
            e.printStackTrace();
        }
    }
    public void setResData(String minSteps){
